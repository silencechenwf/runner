 ...
 * generated in the com.chinasofti.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _TransWordsResponse_QNAME = new QName("http://service.chinasofti.com/", "transWordsResponse");
    private final static QName _TransWords_QNAME = new QName("http://service.chinasofti.com/", "transWords");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.chinasofti.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.chinasofti.com/", name = "transWordsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.chinasofti.com/", name = "transWords")
