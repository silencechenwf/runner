...
public class UserService {
    ...
    public List<Dynamic> state_friend_view(String userName) {
        ...
        for (int i=0;i<friendList.size();i++){
            List<Dynamic> dynamicList1 = dynamicMapper.selectByUserName(friendList.get(i).getFriend());
    ...
    public List<UserInfo> friendListPage(Page page, Register register) {
        ...
        for (int i=0;i<friendList.size();i++){
            UserInfo friendInfo = userInfoMapper.selectByUserName(friendList.get(i).getFriend());
    ...
    public UserInfo friend_search(String friendName) {
        ...
        UserInfo userInfo = userInfoMapper.selectByUserName(friend.getFriend());
        return userInfo;
    }
